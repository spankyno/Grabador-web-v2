  ...
  return (
    <main className="auth-page">
      ...
      <style>{`
        ...
        .auth-title { font-family: var(--font-sans, 'DM Sans', sans-serif); font-size: 1.6rem; font-weight: 800; color: #f1f5f9; letter-spacing: -0.03em; }
        ...
        .auth-input { padding: 0.7rem 1rem; border-radius: 9px; background: #06080e; border: 1px solid #1a2030; color: #f1f5f9; font-size: 0.9rem; font-family: var(--font-sans, 'DM Sans', sans-serif); outline: none; transition: border-color 0.15s; }
        .auth-input:focus { border-color: var(--accent); }
        .auth-input::placeholder { color: #2d3748; }
        .auth-error { font-size: 0.78rem; color: #f87171; background: rgba(248,113,113,0.08); border: 1px solid rgba(248,113,113,0.2); border-radius: 6px; padding: 0.5rem 0.75rem; }
        .auth-submit { margin-top: 0.25rem; padding: 0.75rem; border-radius: 9px; background: var(--accent); color: #000; font-weight: 700; font-size: 0.95rem; font-family: var(--font-sans, 'DM Sans', sans-serif); border: none; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: background 0.15s, transform 0.15s; }
